      ...
      <div className="mb-4 p-3 bg-sky-600 text-white border-2 border-sky-700">
        ...
        <div className="mt-3 flex gap-2">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex-1 py-2 px-3 bg-white/20 hover:bg-white/30 rounded font-retro text-xs text-center transition-all flex items-center justify-center gap-1.5 border border-white/40"
          >
          ...
          <a
            ...
            className="flex-1 py-2 px-3 bg-orange-400/50 hover:bg-orange-400/70 rounded font-retro text-xs text-center transition-all flex items-center justify-center gap-1.5 border border-orange-300/60"
            title="Coming soon!"
          >
            Hacker News
          </a>
